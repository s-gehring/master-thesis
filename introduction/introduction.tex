...
Natural language is most commonly used to transmit information human-to-human. While most of this interaction takes place orally or written on paper, the digital revolution and the rise of social media increased the amount of digitally stored natural language tremendously.\marginnote{\url{https://www.statista.com/statistics/759234/worldwide-natural-language-processing-market-revenues-segment/} zeigt das sehr schön für die Zukunft. Brauche einen Premiumzugang.} Gantz and Reinsel predicted 2012 that the amount of digital data stored globally will double about every two years until at least the year 2020 \cite{gantz2012digital}.
